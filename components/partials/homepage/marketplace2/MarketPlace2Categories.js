            ...
            <div className="ps-section__content">
                <div className="row align-content-lg-stretch">
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail">
                                <img src="/static/img/categories/shop/5.jpg" alt="" />
                            </div>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail">
                                <img src="/static/img/categories/shop/1.jpg" alt="" />
                            </div>
                            <div className="ps-block__content">
                                <h4>Clothings</h4>
                                <ul>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail">
                                <img src="/static/img/categories/shop/9.jpg" alt="" />
                            </div>
                            <div className="ps-block__content">
                                <h4>Computers</h4>
                                <ul>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail">
                                <img src="/static/img/categories/shop/2.jpg" alt="" />
                            </div>
                            <div className="ps-block__content">
                                <h4>Home & Kitchen</h4>
                                <ul>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail">
                                <img src="/static/img/categories/shop/10.jpg" alt="" />
                            </div>
                            <div className="ps-block__content">
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 ">
                        <div className="ps-block--category-2" data-mh="categories">
                            <div className="ps-block__thumbnail">
                                <img src="/static/img/categories/shop/6.jpg" alt="" />
                            </div>
                            <div className="ps-block__content">
                                <h4>Jewelry & Watch</h4>
                                <ul>
